...
class SigesitJuaraController extends ApiBaseController
{
    /**
     * Check Access
     *
    ...
    public function checkAccess(Bool $source = false){
        ...
        if($userSekolah){
            ...
            $result = (new AppClientController)->has_access('sigesit-juara',$sekolah->npsn);
        }
    ...
    public function autologin(){
        ...
        if($hasAccess){
            $grantedLogin = (new AppClientController)->autologin('sigesit-juara', Auth::user()->nik);
