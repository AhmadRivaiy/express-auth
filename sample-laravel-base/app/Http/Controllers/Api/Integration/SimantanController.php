...
class SimantanController extends ApiBaseController
{
     /**
     * Check Access
     *
    ...
    public function checkAccess(Bool $source = false){
        ...
        if($userSekolah){
            ...
            $result = (new AppClientController)->has_access('simantan',$sekolah->npsn);
        }
    ...
    public function autologin(){
        ...
        if($hasAccess){
            $grantedLogin = (new AppClientController)->autologin('simantan', Auth::user()->nik);
