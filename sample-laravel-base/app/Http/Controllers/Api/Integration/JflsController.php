...
class JflsController extends ApiBaseController
{
    /**
     * Check Access
     *
    ...
    public function checkAccess(Bool $source = false){
        $result = (new AppClientController)->has_access('jfls',Auth::user()->nik);
    ...
    public function autologin(){
        ...
        if($hasAccess){
            $grantedLogin = (new AppClientController)->autologin('jfls', Auth::user()->nik);
